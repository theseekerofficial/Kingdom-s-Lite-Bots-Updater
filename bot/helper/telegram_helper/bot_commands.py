...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = getCommand(f'MIRROR_COMMAND', f'mirror{CMD_SUFFIX}'), f'mz{CMD_SUFFIX}'
        self.UnzipMirrorCommand = getCommand(f'UNZIP_COMMAND', f'unzipmirror{CMD_SUFFIX}'), f'uzmz{CMD_SUFFIX}'
        self.ZipMirrorCommand = getCommand(f'ZIP_COMMAND', f'zipmirror{CMD_SUFFIX}'), f'zmz{CMD_SUFFIX}'
        self.LeechCommand = getCommand(f'LEECH_COMMAND', f'leech{CMD_SUFFIX}'), f'lz{CMD_SUFFIX}'
        self.UnzipLeechCommand = getCommand(f'UNZIPLEECH_COMMAND', f'unzipleech{CMD_SUFFIX}'), f'uzlz{CMD_SUFFIX}'
        self.ZipLeechCommand = getCommand(f'ZIPLEECH_COMMAND', f'zipleech{CMD_SUFFIX}'), f'zlz{CMD_SUFFIX}'
        self.CloneCommand = getCommand(f'CLONE_COMMAND', f'clone{CMD_SUFFIX}'), f'cz{CMD_SUFFIX}'
        self.QbMirrorCommand = getCommand(f'QBMIRROR_COMMAND', f'qbmirror{CMD_SUFFIX}'), f'qmz{CMD_SUFFIX}'
        self.QbUnzipMirrorCommand = getCommand(f'QBUNZIP_COMMAND', f'qbunzipmirror{CMD_SUFFIX}'), f'quzmz{CMD_SUFFIX}'
        self.QbZipMirrorCommand = getCommand(f'QBZIP_COMMAND', f'qbzipmirror{CMD_SUFFIX}'), f'qzmz{CMD_SUFFIX}'
        self.QbLeechCommand = getCommand(f'QBLEECH_COMMAND', f'qbleech{CMD_SUFFIX}'), f'qlz{CMD_SUFFIX}'
        self.QbUnzipLeechCommand = getCommand(f'QBZIPLEECH_COMMAND', f'qbunzipleech{CMD_SUFFIX}'), f'quzlz{CMD_SUFFIX}'
        self.QbZipLeechCommand = getCommand(f'QBUNZIPLEECH_COMMAND', f'qbzipleech{CMD_SUFFIX}'), f'qzlz{CMD_SUFFIX}'
        self.ScrapeCommand = getCommand(f'SCRAPE_COMMAND', f'scrape{CMD_SUFFIX}'), f'smz{CMD_SUFFIX}'
        self.YtdlCommand =  getCommand(f'YTDL_COMMAND', f'ytdl{CMD_SUFFIX}'), f'yz{CMD_SUFFIX}'
        self.YtdlZipCommand = getCommand(f'YTDLZIP_COMMAND', f'ytdlzip{CMD_SUFFIX}'), f'yzz{CMD_SUFFIX}'
        self.YtdlLeechCommand = getCommand(f'YTDLLEECH_COMMAND',  f'ytdlleech{CMD_SUFFIX}'), f'ylz{CMD_SUFFIX}'
        self.YtdlZipLeechCommand = getCommand(f'YTDLZIPLEECH_COMMAND', f'ytdlzipleech{CMD_SUFFIX}'), f'yzlz{CMD_SUFFIX}'
        self.MediaInfoCommand = getCommand(f'MEDIAINFO_COMMAND', f'mediainfo{CMD_SUFFIX}'), f'miz{CMD_SUFFIX}'
        self.UserSetCommand  = getCommand(f'USERSET_COMMAND', f'usetting{CMD_SUFFIX}'), f'usz{CMD_SUFFIX}'
        self.BotSetCommand = getCommand(f'BOT_SETTING', f'bsetting{CMD_SUFFIX}'), f'bsz{CMD_SUFFIX}'
        ...
        self.SpeedCommand = getCommand(f'SPEEDTEST_COMMAND', f'speedtest{CMD_SUFFIX}'), f'stz{CMD_SUFFIX}'
